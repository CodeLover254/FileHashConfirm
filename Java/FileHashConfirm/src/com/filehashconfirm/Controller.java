...
public class Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        appLogo.setImage(new Image(getClass().getResourceAsStream("resources/app_logo.png")));
        check = new Image(getClass().getResourceAsStream("resources/tick.png"));
        cancel = new Image(getClass().getResourceAsStream("resources/cancel.png"));
